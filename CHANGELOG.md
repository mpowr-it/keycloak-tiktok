...
[1.0.1]: https://github.com/mpowr-it/keycloak-tiktok/compare/v1.0.0...v1.0.1

### Fixed

* The `scope` parameter in authorization URL was not built correctly and caused missing scope confirmations on TikTok login page.
